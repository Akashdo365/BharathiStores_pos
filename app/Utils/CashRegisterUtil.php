...
class CashRegisterUtil extends Util
{
     ...
     public function getRegisterDetails($register_id = null)
    {
        ...
        $register_details = $query->select(
            ...
            DB::raw("SUM(IF(pay_method='UPI', IF(transaction_type='sell', amount, 0), 0)) as total_upi"),
            DB::raw("SUM(IF(pay_method='UPI', IF(transaction_type='expense', amount, 0), 0)) as total_upi_expense"),
            ...
            DB::raw("SUM(IF(transaction_type='refund', IF(pay_method='UPI', amount, 0), 0)) as total_upi_refund"),
