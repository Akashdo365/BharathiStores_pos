            ...
            <div class="col-md-12 col-sm-12 col-xs-12 right-col tw-pt-20 tw-pb-10 tw-px-5">
                <div class="row">
                    ...
                    <div class="tw-absolute tw-top-2 md:tw-top-5 tw-left-4 md:tw-left-8 tw-flex tw-items-center tw-gap-4"
                        ...
                        <a href="{{ url('/login') }}">
                            <div class="tw-w-64 tw-h-48 tw-flex tw-items-center tw-justify-center tw-mx-auto tw-overflow-hidden tw-p-0.5 tw-mb-4">
    <img src="{{ asset('img/logo-small.png') }}" alt="lock" class="tw-object-fill tw-w-full tw-h-full" />
</div>
