    ...
    <table class="table table-condensed">
      ...
      <tr>
        ...
        <td>
          ...
          <tr>
        <td>
          @lang('cash_register.upi_payment'):
        </th>
        <td>
          <span class="display_currency" data-currency_symbol="true">{{ $register_details->total_upi }}</span>
        </td>
        <td>
          <span class="display_currency" data-currency_symbol="true">{{ $register_details->total_upi_expense }}</span>
        </td>
      </tr>
      <!-- <tr>
        <td>
